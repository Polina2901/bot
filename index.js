...
bot.onText(/\/event/, (msg, match) => {
	...
	` that happens on hour ` +(msg.text.match(/\/event(.*) ([0-9]{1,2})\.([0-9]{1,2})\.([0-9]{2,4})\.([0-9]{1,2})\.([0-9]{1,2})/)[5])
	` on minute ` +(msg.text.match(/\/event(.*) ([0-9]{1,2})\.([0-9]{1,2})\.([0-9]{2,4})\.([0-9]{1,2})\.([0-9]{1,2})/)[6])
